...
parp1_low2hi_cor <- list_correlation(parp1_data, parp1_low2hi_indices)

parp1_hi2low_cor <- list_correlation(parp1_data, parp1_hi2low_indices)
```
...
methyl_low2hi_cor <- list_correlation(methyl_data, methyl_low2hi_indices)

methyl_hi2low_cor <- list_correlation(methyl_data, methyl_hi2low_indices)
```
