...
r2_v_ln4 <- subsample_nonzeros(mcols(tss_windows), c("methyl_r2", "ln4_read"), non_zero = non_zero, n_points = 10000)
ggplot(r2_v_ln4, aes(x = methyl_r2, y = ln4_read)) + geom_point() + scale_y_log10() + scale_x_log10()
...
```{r grab_all}
all_comb <- expand.grid(c("methyl_r1", "methyl_r2"), c("ln4_read", "ln5_read"), stringsAsFactors = FALSE)
all_comb <- rbind(all_comb, c("methyl_r1", "methyl_r2"))
...
```{r genome_graph_test}
genome_r1_v_ln4 <- subsample_nonzeros(mcols(genome_tiles), c("methyl_r1", "ln4_read"), non_zero = non_zero, n_points = 10000)
ggplot(genome_r1_v_ln4, aes(x = methyl_r1, y = ln4_read)) + scale_x_log10() + scale_y_log10() + geom_point()
