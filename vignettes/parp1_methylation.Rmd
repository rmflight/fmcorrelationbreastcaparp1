...
% \VignetteIndexEntry{fmanalysisbreastcaparp1: Methylation}
% \VignetteDepends{GenomicRanges, ggplot2, BSgenome.Hsapiens.UCSC.hg19, fmanalysisbreastcaparp1, fmdatabreastcaparp1}
% \VignettePackage{fmanalysisbreastcaparp1}
-->

# Correlation with Methylated Read Coverage
